namespace PT
{
    public static class Constants
    {
        ...
        public const decimal CORE_SIGNAL_MOD = 3.77M; // Default 2.17, 2.77, 3.5, 3.77, 4.17, max bullmarket 2.0, max bearmarket 5.0
        public const decimal CORE_AVG_WEEK_DIFF_PERCENT = 0.03M;

        public const decimal CORE_HS1_MOD = .17M; // -.88, 0, .17, .74, 1.11 default, 3.77 CORE_EXT_MODE MAX
        public const decimal CORE_HS2_MOD = 1.21M; // 0, .88, 1.21, 1.99 default, 3.99 CORE_EXT_MODE MAX
        public const decimal CORE_HS3_MOD = 1.33M; // 0, .88, 1.33, 1.88 default, 3.99 CORE_EXT_MODE MAX
        public const decimal CORE_HS4_MOD = .47M; // -.88, 0, .17, .47, .88, 1.22 default, 3.88 CORE_EXT_MODE MAX
